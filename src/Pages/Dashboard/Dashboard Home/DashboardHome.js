            ...
            <Container variant='lg'>
                ...
                <Grid container spacing={{ xs: 2, md: 3 }} columns={{ xs: 4, sm: 8, md: 12 }} style={{ margin: '20px 0' }}>
                    <Grid item xs={2} sm={4} md={6} style={{ backgroundColor: '#F4F4F4' }}>
                        <div >
                            <img style={{ width: '40%', borderRadius: '50%' }} src={user.photoUrl || 'https://i.ibb.co/gwzZsXT/No-image-found.jpg'} alt="" />
                        </div>
                    ...
                    <Grid item xs={2} sm={4} md={4} >
                        {
                            admin && <Grid container spacing={{ xs: 2, md: 3 }} columns={{ xs: 4, sm: 8, md: 12 }} sx={{ my: '20px' }}>
                                <Grid item xs={2} sm={4} md={6} style={{ backgroundColor: '#FFCA28', padding: '20px' }}>
                                    <Typography variant="h5" style={{ color: 'white', fontWeight: 'bold' }}>Total Orders</Typography> <br />
                                    <Typography variant="h4" style={{ color: 'white', fontWeight: 'bold', padding: '20px' }}>{orders.length}</Typography>
                                </Grid>
                                <Grid item xs={2} sm={4} md={6} style={{ backgroundColor: '#0E66A1', padding: '20px' }}>
                                    <Typography variant="h5" style={{ color: 'white', fontWeight: 'bold' }}>Total Products</Typography> <br />
                                    <Typography variant="h4" style={{ color: 'white', fontWeight: 'bold', padding: '20px' }}>{products.length}</Typography>
                                </Grid>
